                ...
                <View style={styles.center_data}>
                    ...
                    <View style={{alignItems:'center' , marginTop:15}}>
                        <TouchableOpacity onPress={this.createAccountPress}>
                            <Text style={{fontSize:17 , color:"#7d0633"}}>CREATE ACCONT</Text>
                        </TouchableOpacity>
                        <Text style={{fontSize:12 , color:"#aeaeae"}}>login.(Don't have an account?</Text>
                    </View>

                    <View>
                        <ActivityIndicator style={{paddingTop : hp('2%')}} animating={this.props.log} color="#1e5f74" size="small" />
                    </View>
                </View>
            </View>
        )
